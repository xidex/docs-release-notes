...
When you configure a WAF policy, there is a new option to enable sensitive information detection (SID) for the request and response bodies. See see xref:anypoint-security::create-waf-policy.adoc[Create a Web Application Firewall Security Policy]
