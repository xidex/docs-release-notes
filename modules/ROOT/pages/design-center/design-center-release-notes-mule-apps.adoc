...
// PROJECTX-4888
* The Search endpoint in the extension service was filtering out assets from Anypoint Exchange that did not have mule-plugin files. However, this behavior became incorrect when REST APIs started to be converted to connectors automatically in Exchange. These connectors do not have mule-plugin files.
// PROJECTX-4902
