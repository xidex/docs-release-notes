...
*
* You can now add notes to cards. You can write notes, for example, to explain the purpose of a card or to remind yourself of tasks you still need to complete in a flow.
