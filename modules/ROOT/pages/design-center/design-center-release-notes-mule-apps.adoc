...
* When you open an existing Mule app after a new version of Mule runtime is released, Design Center will display a message stating that the app now uses the latest version of Mule runtime. The Mule app will then restart. This features ensures that Mule apps are always using the latest version of Mule runtime.
