...
* Spend less time searching for options in the easier-to-use toolbar
+
The redesign of the toolbar helps you find more quickly the options for testing, deploying, publishing, and other actions. 
