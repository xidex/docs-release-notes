...
* If you drag and drop a payload element, attribute, or variable into a plain text field, you can click the element, attribute, or variable to see options for transforming the value and a preview of what the value will be.
