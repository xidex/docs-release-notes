...
* Get started creating Mule applications with new Flow Designer templates for the most common use cases
+
Use these templates to connect to JIRA, SurveyMonkey, Email, Salesforce, or Slack. These templates cover a variety of common use cases.

For customer-support teams::
** When a Salesforce case is closed, send a survey via SurveyMonkey.
** Send new issues or updates to existing issues from JIRA to Salesforce.

For engineering teams::
** When a JIRA issue is updated, post a notification to a Slack channel.
** When a High or Highest priority issue is opened in JIRA, post a notification to a Slack channel.

For marketing teams::
** Send a welcome email to new leads that are added to Salesforce.
** Add responses to SurveyMonkey surveys to leads in Salesforce.

+
To use these templates, go to Exchange, select *Provided by MuleSoft*, select *Templates* in the filter drop-down menu, and search for *Flow Designer*.
...
* Access options for testing, deploying, publishing, and more in the easier-to-use toolbar
+
The redesign of the toolbar helps you find what you are looking for more quickly. In addition, when you test an application by running it, a panel appears and displays the URL that the application is listening on.

=== Fixed Issues
// PROJECTX-6834
* The *New Type* dialog did not indicate errors in JSON examples or JSON schemas.
