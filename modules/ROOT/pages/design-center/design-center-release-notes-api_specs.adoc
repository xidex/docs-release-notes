...
// SE-10576
* API specifications that included binary files were not displayed properly in Exchange after being published. For APIs created previously to this release you will need to delete the binary file and import it again, then publish the API to Exchange as a new version to view them correctly.
// SE-11788
