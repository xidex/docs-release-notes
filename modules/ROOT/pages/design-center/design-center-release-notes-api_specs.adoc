...
* Support for enums for strings and numbers
* Support for setting display names for methods
* Support for adding groups to help you organize assets in the left pane
