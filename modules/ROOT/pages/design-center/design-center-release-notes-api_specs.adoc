...
* You can turn on or off the stricter validation that began with the 2.4.0 release on January 10, 2019. You might want to do so if you want to work with in an API-specification project that was created before this date, but don't yet have plans for resolving the messages that this validation displays.
+
...
* The documentation describes additional RAML problems that generate violation and warning messages.
...
// SE-10595
* For a particular API project, the validation step never finished.
// SE-10631
