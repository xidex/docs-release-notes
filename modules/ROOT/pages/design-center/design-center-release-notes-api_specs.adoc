...
* The API editor now includes a button that is labeled *Strict Validation*.
** Click the button to enable strict validation of RAML API specifications according to the new parser that was included in Design Center as of January 10, 2019.
** Unclick the button to return to the less strict validation of RAML API specifications.
