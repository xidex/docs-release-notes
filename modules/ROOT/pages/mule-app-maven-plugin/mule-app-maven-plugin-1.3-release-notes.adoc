= Mule App Maven Plugin 1.3 Release Notes
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]

Mule App Maven Plugin 1.3 is mainly focused on fixing bugs.
...
* Fixed double upload when using release plugin on a domain application with mule-domain-maven-plugin.
