= Mule App Maven Plugin 1.5 Release Notes
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]

Mule App Maven Plugin 1.5 is mainly focused on fixing bugs.
...
* Fixed generation of application package with sources to import it on Studio.
