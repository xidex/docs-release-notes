= API Designer (Pre-Crowd) Release Notes
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]

To read the release notes for the API Designer (Crowd), go xref:design-center/design-center-release-notes-api_specs.adoc[here].
...
* <<API Designer (Pre-Crowd) 0.4.5 Release Notes>>

* <<API Designer (Pre-Crowd) 0.4.4 Release Notes>>
