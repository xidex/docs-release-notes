...
* You can now monitor Web Services connectors in the *Connectors* tab.
* Custom metrics can now be visualized in real time using the built-in *Custom metrics* dashboard.    
