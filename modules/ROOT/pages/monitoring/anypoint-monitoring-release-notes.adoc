...
The Anypoint Monitoring log points feature is only supported on Anypoint runtime version 3.8.5-AM or later. For APIs not running on Anypoint runtime 3.8.5-AM or later, the log points feature does not appear for the API.
