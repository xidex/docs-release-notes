...
. In built-in dashboards, you can export data for an app into a CSV file. For more information, see xref:export-app-data-to-csv.adoc[Export App Data to a CSV File].
