...
If you have Anypoint Monitoring enabled for applications running on 3.9.x-AM or 4.x-AM, monitoring will continue to work. However, updating your applications to run on mainline Mule versions (3.9.x and 4.x) is recommended to ensure you receive patch updates as soon as they are available. 
