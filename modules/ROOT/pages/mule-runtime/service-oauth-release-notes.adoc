...
* Support Client Credentials gran type in the SDK (link:https://www.mulesoft.org/jira/browse/MULE-16908[MULE-16908]) 
...
|===
|Issue |Description
| link:https://www.mulesoft.org/jira/browse/MULE-17006[MULE-17006] | Reuse http clients for OAuth token request
|=== 
