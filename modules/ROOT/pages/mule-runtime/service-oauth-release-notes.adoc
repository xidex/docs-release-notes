...
* Support Client Credentials grant type in the SDK. (https://www.mulesoft.org/jira/browse/MULE-16908[MULE-16908]) 
 
 
=== Fixed Issues 
 
* AuthorizationCodeState not updated on certain circumstances. (https://www.mulesoft.org/jira/browse/MULE-16540[MULE-16540])
...
* Reuse HTTO clients for an OAuth token request. (https://www.mulesoft.org/jira/browse/MULE-17006[MULE-17006])
...
* Reuse HTTP clients for an OAuth token request. (https://www.mulesoft.org/jira/browse/MULE-17006[MULE-17006])
