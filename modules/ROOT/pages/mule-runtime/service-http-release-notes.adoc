...
* HTTP request streaming throws out of memory (https://www.mulesoft.org/jira/browse/MULE-16756[MULE-16756])
...
* Local authentication doesn't prevail when there're multiple authentication method headers (https://www.mulesoft.org/jira/browse/MULE-16308[MULE-16308])
