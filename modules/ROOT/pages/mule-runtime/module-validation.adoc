...
* | MULE-15767 | Add an `any` validator  
...
|Issue |Description
// Fixed Issues 
| MULE-15342 | Validation module is-time operation accepts invalid dates 
| MULE-14971 | DW null output with JSON datatype not validated as null 
//  
// ------------------------------- 
