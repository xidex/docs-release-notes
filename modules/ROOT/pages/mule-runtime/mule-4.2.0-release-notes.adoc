...
| MULE-14203 | In `scheduler-pools.conf`, some default values for the file changed. Please apply these changes if this configuration file is being carried over from a previous version:
