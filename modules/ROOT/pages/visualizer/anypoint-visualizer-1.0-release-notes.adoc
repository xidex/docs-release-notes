...
** When a service connects to a service in an organization in which a user does not have the “CloudHub Viewer” permission, the service is displayed as an HTTP node. 
