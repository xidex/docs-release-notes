...
* Side Panel
** Added the ability to add tags to services by the UI or properties
** Moved layer assignment from Details panel to Customization panel
** Added filtering by tags
** Added *Include related services* button to Services filter
