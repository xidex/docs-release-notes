...
* Anypoint Monitoring Agent Moving to Mule Version 3.9 Non-AM Runtimes
...
* Visualizer Supports Dedicated Load Balancer with Mule Version 3.9.x
+
Visualizer supports dedicated load balancers for apps using Mule version 3.9.x.
+
[NOTE]
While Visualizer doesn't yet support dedicated load balancers for apps using Mule version 4.1.x and 4.1.x-AM, MuleSoft anticipates that support for Mule version 4.2.
