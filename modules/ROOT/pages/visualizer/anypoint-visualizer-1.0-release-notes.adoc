...
Due to a potential performance impact for Mule 4.1.x, header injection in the Anypoint Monitoring agent is now disabled by default.
...
For instructions, see xref:visualizer::setup.adoc[Set up Anypoint Visualizer].
