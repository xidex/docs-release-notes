...
* xref:connector-devkit/anypoint-connector-devkit-3.9.x-release-notes.adoc[3.9.0 and Newer]
* xref:connector-devkit/anypoint-connector-devkit-3.8.0-release-notes.adoc[3.8.0 and Newer]
