= Anypoint Studio 7.3 with Mule Runtime Engine 4.2.0 Update Site 4 Release Notes
...
* Studio 7.3.4 release includes two important bug fixes and comes bundled with Mule runtime engine 4.2.0 runtime.
