...
The 6.6.1 Studio release includes a number of bug fixes and comes with Mule 3.9.1 runtime.
...
* Fixed issue where ,ultiple Transform Message property files caused Studio to slowdown.
* Fixed issue preventing to have multiple `xmlns` namespace declarations in root element for DataWeave.
* Fixed performance issues while using DataWave.
