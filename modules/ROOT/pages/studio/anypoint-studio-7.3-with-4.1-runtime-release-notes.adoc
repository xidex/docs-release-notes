...
* Projects created or updated with Studio 7.3.x or 7.2.x are not compatible with 7.1.x due to some improvements with the management of the mule-artifcat.json file. The content of the file was reduced and part of the content used to be required by Studio 7.1.x. +
...
You can now toggle between "literal" and "expression mode" using the new expression button. Expression mode, accepts and auto-suggestions dataweave 2.0.
+
image::anypoint-studio-7.3-with-4.1-runtime-release-notes-e98c6.png[]
+
...
+
image::anypoint-studio-7.3-with-4.1-runtime-release-notes-8ac2f.png[]
...
+
image::anypoint-studio-7.3-with-4.1-runtime-release-notes-ddbe5.png[]
+
...
+
image::anypoint-studio-7.3-with-4.1-runtime-release-notes-98301.png[]
* Embedded Documentation. +
Studio now offers contextual documentation inside the *Help* tab for all connectors.
+
image::anypoint-studio-7.3-with-4.1-runtime-release-notes-e13c8.png[]
* Enhanced Datasense. +
...
* When setting target value field in HTTP Request, metada propagation is not set correctly.
* Copy Paste keyboard shortcuts doesn't work.
...
* When setting metadata to a Choice field, it does not do nothing.
...
* Studio freezes when editing medium size DataWeve file in the transform component.
