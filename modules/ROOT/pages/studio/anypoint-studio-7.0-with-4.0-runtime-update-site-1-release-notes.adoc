= Anypoint Studio 7.0 with Mule Runtime Engine 4.0.0 Update Site 1 Release Notes
...
For first time installment, please refer to xref:studio/anypoint-studio-7.0-EA-with-4.0-runtime-release-notes.adoc[Anypoint Studio 7.0.0 EA with Mule Runtime Engine 4.0.0 Release Notes] for hardware requirements and known issues.
...
Users must migrate Mule 3 projects to Mule 4 manually, before they can be used in Studio 7. See xref:mule-runtime::migration-core.adoc[Migrating Core Components] for a list of changes.
