= Anypoint Studio 7.3 with Mule Runtime Engine 4.1.4 Update Site 2 Release Notes
...
* Studio 7.3.2 comes bundled with Mule Runtime Engine 4.1.4, however you can use it with earlier Mule Runtime versions as early as 4.1.1.
