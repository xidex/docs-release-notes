...
When running `designcenter project list`, you can now pass `--pageIndex` to set them number of the page to retrieve from a paginated , and `--pageSize` to set the number of results per page. 
