...
When running `designcenter project list`, you can now pass `--pageIndex` to set the number of pages to retrieve, and `--pageSize` to set the amount of results per page. 
