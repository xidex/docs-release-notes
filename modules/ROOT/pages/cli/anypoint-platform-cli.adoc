...
When running `designcenter project list`, you can now pass `--pageIndex` to set number of the page to retrieve from a paginated project, and `--pageSize` to set the amount of results per page. 
