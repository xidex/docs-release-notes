...
See xref:runtime-manager/runtime-manager-2.8.4-release-notes.adoc[Runtime Manager v2.8.2]
...
See xref:runtime-manager/runtime-manager-2.8.2-release-notes.adoc[Runtime Manager v2.8.2]

== 2.8.1 - February 22, 2018

See xref:runtime-manager/runtime-manager-2.8.1-release-notes.adoc[Runtime Manager v2.8.1]

== 2.8.0 - January 25, 2018

See xref:runtime-manager/runtime-manager-2.8.0-release-notes.adoc[Runtime Manager v2.8.0]

== 2.7.0 - January 13, 2018

See xref:runtime-manager/runtime-manager-2.7.0-release-notes.adoc[Runtime Manager v2.7.0]

== 2.6.1 - November 19, 2017

See xref:runtime-manager/runtime-manager-2.6.1-release-notes.adoc[Runtime Manager v2.6.1]

== 2.6.0 - October 20, 2017

See xref:runtime-manager/runtime-manager-2.6.0-release-notes.adoc[Runtime Manager 2.6.0].

== 2.5.0 - September 9, 2017

See xref:runtime-manager/runtime-manager-2.5.0-release-notes.adoc[Runtime Manager 2.5.0].

== 2.4.3 - August 26, 2017

See xref:runtime-manager/runtime-manager-2.4.3-release-notes.adoc[Runtime Manager 2.4.0].

== 2.4.0 - June 24, 2017

* Enables Runtime Manager to display additional information about remote server.

See xref:runtime-manager/runtime-manager-2.4.0-release-notes.adoc[Runtime Manager 2.4.0].

== 2.3.1 - June 3, 2017

* Enables restart and shutdown of servers in hybrid deployment scenarios.

See xref:runtime-manager/runtime-manager-2.3.1-release-notes.adoc[Runtime Manager 2.3.1].
...
See xref:runtime-manager/runtime-manager-2.3.0-release-notes.adoc[Runtime Manager 2.3.0].
...
See xref:runtime-manager/runtime-manager-2.2.0-release-notes.adoc[Runtime Manager 2.2.0].
...
See the full xref:runtime-manager/runtime-manager-2.1.0-release-notes.adoc[Runtime Manager 2.1.0].

== 2.0 - November 19, 2016
...
See the full xref:runtime-manager/runtime-manager-2.0-release-notes.adoc[Runtime Manager 2.0].

== 1.5.1 - August 27, 2016

This release includes a few minor enhancements.


See the full xref:runtime-manager/runtime-manager-1.5.1-release-notes.adoc[Anypoint Runtime Manager 1.5.1].
...
See the full xref:runtime-manager/runtime-manager-1.5.0-release-notes.adoc[Anypoint Runtime Manager 1.5.0].
...
See the full xref:runtime-manager/runtime-manager-1.4.1-release-notes.adoc[Anypoint Runtime Manager 1.4.1].
...
See the full xref:runtime-manager/runtime-manager-1.4.0-release-notes.adoc[Anypoint Runtime Manager 1.4.0].
...
See the full xref:runtime-manager/anypoint-runtime-manager-1.3.1-release-notes.adoc[Anypoint Runtime Manager 1.3.1].
...
See the full xref:runtime-manager/anypoint-runtime-manager-1.3-release-notes.adoc[Anypoint Runtime Manager 1.3].
...
See the full xref:runtime-manager/runtime-manager-1.2.0-release-notes.adoc[Anypoint Runtime Manager 1.2.0].
