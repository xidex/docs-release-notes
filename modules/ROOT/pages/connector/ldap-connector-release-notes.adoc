...
* Returned attributes names were normalized to lowercase (SE-1147) - This fix will prevent the conversion of attributes names to lowercase.
...
* Fixed issue regarding transformation of an LDAPEntry to a string which was causing java.lang.ArrayIndexOutOfBoundsException.
