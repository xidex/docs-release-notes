...
|===
|Issue |Description
| https://www.mulesoft.org/jira/browse/MULE-14822[MULE-15809] | MULE-15809: setting refreshTokenWhen=true in oauth:authorization-code-grant-type fails with exception
|===
...
|===
|Issue |Description
| https://www.mulesoft.org/jira/browse/MULE-15809[MULE-15809] | Setting refreshTokenWhen=true in oauth:authorization-code-grant-type fails with exception
|===
...
|===
|Issue |Description
| https://www.mulesoft.org/jira/browse/MULE-11272[MULE-11272] | Support non-blocking in OAuth http calls
|===
...
|===
|Issue |Description
| https://www.mulesoft.org/jira/browse/MULE-15539[MULE-15539] | OAuth: Provide option `encodeClientCredentialsInBody` in authCode
|===
...
|===
|Issue |Description
| https://www.mulesoft.org/jira/browse/MULE-14822[MULE-14822] | ConfigurationException: Element 'tokenManagerConfig-MyCon
|===
