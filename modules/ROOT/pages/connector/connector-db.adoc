...
* Connector doesn't ensure data is consumable by DataWeave when it's encoded with an encoding different from the one used by the runtime. (https://www.mulesoft.org/jira/browse/MULE-16460[MULE-16460])
