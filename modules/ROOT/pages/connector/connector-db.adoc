...
* Default MySQL Driver causes a memory leak https://www.mulesoft.org/jira/browse/MULE-15748[(MULE-15748)]
* Can't get stored procedure name from sql query when there are whitespaces before parentheses https://www.mulesoft.org/jira/browse/MULE-15793[(MULE-15793)]
