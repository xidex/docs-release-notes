...
* On stored procedures where output return variable is set to null, output should not be processed further. (https://www.mulesoft.org/jira/browse/MULE-16961[MULE-16961])
