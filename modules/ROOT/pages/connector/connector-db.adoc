...
|===
|Issue |Description
| link:https://www.mulesoft.org/jira/browse/MULE-16589[MULE-16589] | Errors while transforming to json the output of oracle SP call with custom types
| link:https://www.mulesoft.org/jira/browse/MULE-16685[MULE-16685] | Can't get parameter data types when store procedure name includes schema
| link:https://www.mulesoft.org/jira/browse/MULE-16366[MULE-16685] | FlowListener callback retains too much state
|===
...
|===
|Issue |Description
| link:https://www.mulesoft.org/jira/browse/MULE-16401[MULE-16401] | Errors when using Oracle's UDT Table type
| link:https://www.mulesoft.org/jira/browse/MULE-16484[MULE-16484] | DB Connector not sending value of IN-OUT Parameter
| link:https://www.mulesoft.org/jira/browse/MULE-16339[MULE-16339] | "Unable to convert between" error when using SP in MsSql
|===
