...
* Test connection button in Anypoint Studio for kafka connector does not work in Mule 4, Looks like the default connector template for "Test Connection" button is incorrect. (SE-11817)
