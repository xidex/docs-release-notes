...
* Customer facing SAP Connector not able to update SAP correctly when IDOCs sent as collection. (SE-11221)
* SAP Connector not accepting slash "/" on BAPI function call. (SE-10952)
