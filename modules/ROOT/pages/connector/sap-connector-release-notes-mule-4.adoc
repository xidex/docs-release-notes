...
* Configuring SNC in SAP connector was not working. Added message server configuration parameters: String host, String systemId, Integer port, String group, String router - these are reflections of JCo properties. (SE-10985)
