...
* Retrieving 50K records using SAP connectors results in OOME inconsistently at 1.5 GB heap memory. (CONN-1838)
* Unable to define RFC timeout setting in SAP connector in Mule4.(SE-12045)
