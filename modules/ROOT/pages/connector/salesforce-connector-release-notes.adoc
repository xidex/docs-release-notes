...
IMPORTANT: This known issue affects all v8.x versions of the Salesforce connector: The "Resume from the last replay ID” doesn’t work on CloudHub because the persistent object store is not supported by CloudHub.
