...
IMPORTANT: In Salesforce connector v8.1.0 and later, in the `Replay Topic` and `Replay Stream Channel` operations, the `FROM_REPLAY_ID` value in the *replayOption* field is not supported for use in CloudHub.
