...
* _Metadata not populated correctly in Salesforce query-all with nested query (SE-10720)_. Query Operations now have proper datasense support for nested queries
