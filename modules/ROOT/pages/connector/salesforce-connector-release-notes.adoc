...
IMPORTANT: From Salesforce connector v8.1.0 and later, the `Replay Topic` and `Replay Stream Channel` operations' *replayOption* field's FROM_REPLAY_ID value is not supported for use in CloudHub.
