...
* xref:connector/msmq-connector-release-notes.adoc[MSMQ connector]
* xref:connector/windows-powershell-release-notes.adoc[PowerShell Connector]
* xref:connector/microsoft-dynamics-crm-connector-release-notes.adoc[Dynamics CRM Connector]
* xref:connector/microsoft-dynamics-ax-2012-connector-release-notes.adoc[Dynamics AX Connector]
...
* Keeping Windows Service configuration settings (after installing this version, future upgrades will keep the Windows Service configuration updated if customized).
