...
* The JCA resource adapter must match the CICS TG platform. For example, if you have CICS TG for Multiplatforms, you cannot connect with it, to, or from a CICS TG that uses the z/OS resource adapter.
====
