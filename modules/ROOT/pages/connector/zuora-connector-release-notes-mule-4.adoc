...
Version 4.2.0 of the connector supports the Zuora API release 247 from 2019-05-27.

Api updates info can be found starting with the following link https://community.zuora.com/t5/Developers/API-Changelog/gpm-p/18092/page/6#toc-hId-475278289.

The list of releases Zuora releases is available here: https://knowledgecenter.zuora.com/A_Zuora_Release_Notes/A_Zuora_Billing_Release_Notes
