...
Api updates info can be found starting with the following link https://community.zuora.com/t5/Developers/API-Changelog/gpm-p/18092/page/6#toc-hId-475301508
