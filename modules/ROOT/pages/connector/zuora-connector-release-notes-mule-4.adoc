...
* Updated HTTP Connector dependency to version 1.5.5 (CONN-2524)
...
* https://community.zuora.com/t5/Developers/API-Changelog/gpm-p/18092/page/6#toc-hId-475301508[Zuora API updates change log]. 
* https://knowledgecenter.zuora.com/A_Zuora_Release_Notes/A_Zuora_Billing_Release_Notes[List of Zuora releases]. 
