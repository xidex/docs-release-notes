...
* *WADL Alias* - Users needed to define the alias of deployed WADLs as their internal names, lower-cased. This new version fixes that and this is no longer required.
