...
* Update java mail to jakarta 1.6.3, java activation to jakarta 1.2.1 and parent version to 1.1.5 to be sure that the only transitive dep is javax.activation 1.2.1 (https://www.mulesoft.org/jira/browse/MULE-17052[MULE-17052])
