...
* Updated Java mail to Jakarta 1.6.3, Java activation to Jakarta 1.2.1, and the parent version to 1.1.5 to be sure that the only transitive dependency is javax.activation 1.2.1. (https://www.mulesoft.org/jira/browse/MULE-17052[MULE-17052])
...
* Email as attachment is not recognized by the Email connector. (https://www.mulesoft.org/jira/browse/MULE-16617[MULE-16617])
