...
* Fixed a bug that prevented the usage of email attachments if dispatched by the IMAP source. (MULE-16388)
* Email Connector now requests socket factory directly. (MULE-16190)
