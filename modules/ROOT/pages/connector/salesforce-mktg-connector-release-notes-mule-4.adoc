...
* Cannot connect to Salesforce Marketing: com.ctc.wstx.exc.WstxEOFException: Unexpected EOF in prolog. The issue was fixed wrapping the thrown exception to a more readable one.
