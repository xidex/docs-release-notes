...
* SFMC (Salesforce Marketing Connector) erroneously appending timestamp to value in SQL statement(SE-11603)
* Added some missing dependencies so the connector works with Mule Runtime 4.2.0 and Java 11. Added depdendencies are: com.sun.xml.messaging.saaj:saaj-impl:1.5.1, javax.ws.rs:javax.ws.rs-api:2.1.1 and javax.xml.ws:jaxws-api:2.3.1
