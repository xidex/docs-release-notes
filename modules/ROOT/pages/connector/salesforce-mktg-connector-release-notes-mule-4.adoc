...
* Salesforce Marketing Cloud Connector does not parse query correctly - The connector now translates SOQL query correctly when including clauses in parenthesis(SE-11721).
...
* Now works with Mule Runtime 4.2.0 and Java 11. Added the following missing dependencies: com.sun.xml.messaging.saaj:saaj-impl:1.5.1, javax.ws.rs:javax.ws.rs-api:2.1.1 and javax.xml.ws:jaxws-api:2.3.1
