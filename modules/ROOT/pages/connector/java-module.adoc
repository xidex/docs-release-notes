...
* Fixed an issue when invoking a method from a class that implements an interface
...
| https://www.mulesoft.org/jira/browse/MULE-16316[MULE-16316] |  JavaModule: no longer throws WARN messages with Generic interface implementation.
