...
* Fixed issue that caused the signature and the timestamp being wrongly swapped when signing the timestamp.(MULE-16834)
...
* Fixed issue that caused the connector to fail when finding attachments when element has namespace. (MULE-16592)
