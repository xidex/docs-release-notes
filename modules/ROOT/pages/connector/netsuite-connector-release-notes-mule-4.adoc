...
* HTTP Proxy for RESTlet operations: a new fix was implemented. Previously, the proxy configuration was ignored by the dynamic endpoint resolution. It now works as expected.
