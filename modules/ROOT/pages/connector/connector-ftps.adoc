...
* Fixed an issue that prevented to read files that had a space on its name.
...
* Fixed bug that made the connector get stuck while reading files from remote server, degrading performance.
