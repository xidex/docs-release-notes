...
* Batch aggregator executed an Upsert operation and did not return the right number of failed records when something went wrong. (SE-10501)
* NullPointerException occurred when resolving metadata. (CONN-1938)
* OAuth v2.0 fails to get right session and throws INVALID_SESSION_ID after being idle. This was fixed partially for core operations (Create, Retrieve, Upsert, Update, Merge, Delete, Convert Lead, Find Duplicates and others). (SE-10988)
