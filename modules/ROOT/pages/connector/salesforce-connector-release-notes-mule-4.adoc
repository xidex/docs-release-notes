...
* The connector was not able to handle empty body requests to Apex services. Now this is fixed.
* Fixed an issue where for the Retrieve operation when the id specified was invalid the connector was trying to reconnect because of a wrong exception that was thrown.
