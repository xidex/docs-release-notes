...
* Fixed an issue on the Replay Streaming Channel where the source stopped working and receiving messages after 48 hours.Fixed by handling DISCONNECTED state of SalesforceBayeuxClient.
