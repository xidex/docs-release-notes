...
The connector was unable to properly stream large files to Dataweave. By adding content length value as a message attribute, this issue was fixed.

Test connection functionality did not work properly, this release solved the mentioned issue.
