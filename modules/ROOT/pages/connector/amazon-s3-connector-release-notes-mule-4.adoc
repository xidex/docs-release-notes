...
|AWS SDK for Java	|1.11.594
|===

=== Fixed in this Release

* Connector did not allow users to configure the URL for S3 compatible storage. Users can now use the new _S3 Compatible Storage URL_ parameter to configure S3 compatible storage. [SE-10846]
...
* Connector was not displaying tooltips for the parameters when configuring a connection. This issue is now fixed. [CONN-2685]
