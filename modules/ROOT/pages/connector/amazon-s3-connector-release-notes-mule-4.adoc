...
* Connector was unable to work with the lowercase region values or region values containing dashes. This issue was fixed by adding support for lowercase region values and region values with dashes. [CONN-1942]
