...
* Added support for different (https://docs.mulesoft.com/connectors/ibm/ibm-mq-publish-consume[Request Reply patterns]) for Publish Consume Operation and Listener.
