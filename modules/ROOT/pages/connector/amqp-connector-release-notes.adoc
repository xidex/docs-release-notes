...
*December 2018 - 3.8.4* +
*December 2018 - 3.7.12*

_Select_

AMQP Connector has two active versions each supporting different versions of the RabbitMQ library. AMQP Connector
version 3.8.4 supports RabbitMQ client library 5.3.0 and requires JDK 8. AMQP Connector 3.7.12 supports RabbitMQ client library 4.6.0.
...
AMQP connector is overwritting threadpool.amqpReceiver from other instances of the connector. (AMQP-112)
