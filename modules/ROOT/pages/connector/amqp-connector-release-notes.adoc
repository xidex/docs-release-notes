...
version 3.8.x supports RabbitMQ client library 5.3.0 and requires JDK 8. AMQP Connector 3.7.x supports RabbitMQ client library 4.6.0.
...
Problem on switching primary node. Cluster notification is ignored. (AMQP-123)
