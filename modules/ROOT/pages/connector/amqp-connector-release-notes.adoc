...
*October 2018 - 3.8.2* +
*September 2018 - 3.7.11*

_Select_

AMQP Connector has two active versions each supporting different versions of the RabbitMQ library. AMQP Connector
version 3.8.2 supports RabbitMQ client library 5.3.0 and requires JDK 8 and later. AMQP Connector 3.7.11 supports RabbitMQ client library 4.6.0.
