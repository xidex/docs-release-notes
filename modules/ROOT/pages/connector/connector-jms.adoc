...
* JMS Consume doesn't rollback correctly on XA transactions (https://www.mulesoft.org/jira/browse/MULE-16969[MULE-16969])
* JMS Bridge with XA hands in some cases
