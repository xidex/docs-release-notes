...
* Added support for different (https://docs.mulesoft.com/connectors/jms/jms-publish-consume[Request Reply patterns]) for Publish Consume Operation and Listener.
...
* The JMS Consume operation didn't roll back correctly on XA transactions. (https://www.mulesoft.org/jira/browse/MULE-16969[MULE-16969])
...
* Make XA pool configurable in the JMS connector. (https://www.mulesoft.org/jira/browse/MULE-16926[MULE-16926])
