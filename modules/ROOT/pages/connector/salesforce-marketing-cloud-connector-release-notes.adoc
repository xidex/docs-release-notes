...
* Cannot connect to Salesforce Marketing: com.ctc.wstx.exc.WstxEOFException: Unexpected EOF in prolog - Wrapped the exception in a more readable one.  (SE-10880)
