...
* Cannot connect to Salesforce Marketing: com.ctc.wstx.exc.WstxEOFException: Unexpected EOF in prolog (SE-10880) - Wrapped the exception in a more readable one.
