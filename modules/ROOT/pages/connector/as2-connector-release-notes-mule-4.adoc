...
* The app was failing with both send and receive requests because it was starting to process files before they were completely transferred.
* Releasing threads and file operations from the Send process was increasing the size of the thread pool and many operations were failing.
