...
* The connector process receive request until file is completed transferred.
* The send process is releasing threads and files operations used during the transferring in a safe mode.
* Delete the file after receive process ended for suport send and receive operations in same instance.
