...
* Mule LDAP Connector Search and Lookup returns multi-value attribute as String if there is only one element, and as an array if there is more than one (SE-11864)
