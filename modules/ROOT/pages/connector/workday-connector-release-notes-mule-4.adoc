...
[IMPORTANT]
Depending on the connectivity conditions while using the Workday connector in Anypoint Studio, there can be a timeout when obtaining Workday metadata. See xref:connectors::workday/workday-studio.adoc#to-increase-timeout-in-studio[To Increase Timeout in Studio].
