...
*  List operation fails to list files in a directory when encountering file without read permissions. (MULE-16819)
* On Windows, List operation fails to list files in a directory where a file has been deleted just before the list operation is executed. (MULE-16827)
