...
|Anypoint Enterprise Security |1.8.2 |n/a |3.9.x
|===

=== Fixed in this Release

* `ClientCredential` grant inconsistent error codes. (SEC-333)
* OAuth2Provider fails to create http endpoint when listener is on domain. (SEC-335)
...
* MULE-14382: Upgraded BouncyCastle to 1.59.
* SEC-319: Race condition when concurrent requests use the same refresh.
