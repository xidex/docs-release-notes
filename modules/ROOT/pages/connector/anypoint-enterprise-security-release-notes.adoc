...
[%header,cols="4*"]
|===
|  |Enterprise |Community |Mule Runtime Version Compatibility
|Anypoint Enterprise Security |1.8.1 |n/a |3.9.x
|===

=== Fixed in this Release

* OAuth Provider: token request for clientCredentials with encoded credentials fails (EE-6223)
* OAuth Provider: token response body is json, but content-type header is application/x-www-form-urlencoded. (EE-6224)
* Fix OAuth2ProviderModuleCoreTestCase tests after jetty upgrade. (SEC-332)
...
* Upgrade BouncyCastle to 1.60. (MULE-15332)
* OAuth Provider: token request for clientCredentials with encoded credentials fails. (EE-6223)
* OAuth Provider: token response body is JSON, but content-type header is application/x-www-form-urlencoded. (EE-6224)
...
|===
|AES version |Mule Runtime Version
|1.8.1 |3.9.0 or later
|1.8.0 |3.9.0 or later
|1.7.6 |3.9.0 or later
|1.7.5 |3.9.0 or later
|1.7.4 |3.9.0 or later
|1.7.3 |3.9.0 or later
|1.7.2 |3.9.0 or later
|1.7.1 |3.9.0 or later
|1.7.0 |3.9.0 or later
|1.6.9 |3.8.1 or later
|1.6.8 |3.8.1 or later
|1.6.7 |3.8.1 or later
|1.6.6 |3.8.1 or later
|1.6.5 |3.8.1 or later
|1.6.4 |3.8.1 or later
|1.6.3 |3.8.1 or later
|1.6.2 |3.8.1 or later
|1.6.0 |3.8.0 or later
|1.5.4 |3.7.3
|1.5.3 |3.7.3
|1.5.2 |3.7.3
