...
* Source completion callback not called on failure causing leaks. (https://www.mulesoft.org/jira/browse/MULE-16634[MULE-16634])
* Add missing MediaType to HTTP operations, equals/hash to CORS components and upgrade CORS to 1.1.2 (https://www.mulesoft.org/jira/browse/MULE-16632[MULE-16632])
