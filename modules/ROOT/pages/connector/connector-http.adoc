...
* No transformers for Iterator to byte[] or String cause error. (https://www.mulesoft.org/jira/browse/MULE-15991[MULE-15991])
* Reduce logging verbosity when correlations ids are repeated but matching (https://www.mulesoft.org/jira/browse/MULE-17115[MULE-17115])
