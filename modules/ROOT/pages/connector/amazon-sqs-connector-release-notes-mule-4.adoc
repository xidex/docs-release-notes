...
* Receive message source was not using the default global queue URL when queue URL was not specified, consequently an error was thrown after the application deploy. This version fixes this issue. [SE-12178] 
