...
Anypoint Platform provides these steps to complete the upgrade to the xref:release-notes::platform/release-notes/anypoint-november-release.adoc[November 2017 Anypoint Platform software release]:
