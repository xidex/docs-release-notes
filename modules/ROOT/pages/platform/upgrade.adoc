...
Anypoint Platform provides these steps to complete the upgrade to the xref:release-notes::platform/release-notes/upgrade.adoc[November 2017 Anypoint Platform software release]:
