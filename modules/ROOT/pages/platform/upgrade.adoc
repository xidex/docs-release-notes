...
Yes, API policies will remain in effect.
...
* Exchange: Assign the user at least the Exchange Viewers role to allow the user access to all Exchange assets within the business group in which you have assigned the permission. Portals Viewer role is deprecated.
