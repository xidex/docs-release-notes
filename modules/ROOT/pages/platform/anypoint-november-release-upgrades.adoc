= Upgrade Notice for Anypoint Platform (November Release)
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]

The November (Crowd) release includes many improvements across API Designer, API Portal, and API Manager.
