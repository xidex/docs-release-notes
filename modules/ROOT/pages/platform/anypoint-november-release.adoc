= Anypoint Platform July and November 2017 Release: Release Notes
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]

This topic describes the major feature enhancements added for the July and November, 2017 releases of Anypoint Platform. To prepare for the upgrade see xref:platform/upgrade.adoc[Anypoint Platform Upgrade to Latest Software Guide].
