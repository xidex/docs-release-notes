...
* Fixed: kubernetes version upgraded to v1.9.12
* Fixed: Removed telegraf depedency from gravitational package.
* Fixed: Fixed init script failure in RTF installion in single node using proxy.
