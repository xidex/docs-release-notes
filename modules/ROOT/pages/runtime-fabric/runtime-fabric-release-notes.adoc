...
== 1.1.373 - February 6, 2019

This release includes the following fixes and enhancements:

* Added: Support for RHEL 7.6
* Added: HTTPS-based connectivity to control plane. (Replaces TCP-based connectivity).
* Added: JVM memory heap monitoring in OpsCenter 'Applications' dashboard.
* Fixed: User-specified HTTP proxy configuration is retained across updates.
* Added: Java upgraded to 8u191
