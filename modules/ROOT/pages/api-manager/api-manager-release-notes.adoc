...
* Improved UI modal for changing Mule 3 custom policy version: https://docs.mulesoft.com/api-manager/2.x/change-custom-policy-mule3
...
* xref:api-manager::custom-policy-getting-started.adoc[Custom policy development] has changed.
