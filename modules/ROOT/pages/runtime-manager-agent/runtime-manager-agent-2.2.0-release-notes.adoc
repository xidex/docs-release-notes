...
The agent upgrade procedure results in the use of two new endpoints for communicating with Anypoint Runtime Manager. Before doing any upgrade, ensure there is no networking constraint for accessing the following FQDNs on port 443:
