...
* The Runtime now uses AdoptOpenJDK 1.8 instead of Oracle JDK.
* API Caching Policy: there is an important update included for this policy. Please read its xref:policies/http-caching-release-notes.adoc[release notes].
* For information about changes and improvements in the 4.2.0 Runtime, please refer to its xref:mule-runtime/mule-4.2.0-release-notes.adoc[release notes].
