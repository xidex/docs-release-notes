...
These are the release notes for patches made to the Mule runtimes on CloudHub. In addition to these release notes, see the xref:cloudhub/cloudhub-release-notes.adoc[CloudHub release notes] and complete xref:runtime-manager::cloudhub.adoc[CloudHub] documentation.
...
* JSON validation fails "error: object instance has properties which are not allowed by the schema:"	[SE-11753]
...
* Fix class loading isolation issues when initialising apps. [SE-11887]
...
* Remove unexpected warnings and errors related to file system permissions in logs when using secure properties [SE-7975] 
