...
Mule 4.1.1-4.1.5 with Monitoring feature enabled:
 
Fix `NullPointerException` reported in the logs by some connectors (SE-11483)
...
3.9.2 with Monitoring enabled:

* Fix `NullPointerException` reported in the logs by some connectors (SE-11483)
* Some inbound request failures are not taken into account (SE-10544)
* Visualizer properties are not picked up from `mule-app.properties` file (SE-10374)

3.9.1 with Monitoring enabled:

* Fix `NullPointerException` reported in the logs by some connectors (SE-11483)
* Some inbound request failures are not taken into account (SE-10544)
* Visualizer properties are not picked up from `mule-app.properties` file (SE-10374)

3.9.0 Runtime Update with Monitoring enabled:
