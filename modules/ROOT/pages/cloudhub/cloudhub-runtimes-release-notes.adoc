...
* Update OAuth service to version 1.3.1. [SE-12028]
...
3.9.3, 3.9.2, 3.9.1 and 3.9.0 Runtime Update:

* SSL Cipher Suites list changed with latest patch of 3.9.0 and 3.9.1 in CH. [SE-12252]

3.8.7, 3.8.6, 3.8.5, 3.8.4, 3.8.2, 3.8.1 and 3.8.0 Runtime Update:

* In case no defaultCipherSuites are specified use all those supported by enabled protocols. [SE-12252]
