...
* Fix for CloudHub logs not seen issue. (SE-11744, SE-11514)
* Mule 4 Persistent queue fixes related to vm:listener and NullPointerException when using Batch module with persistent queues. (SE-11698, SE-10583, SE 11599)
...
* Beta improved UI unified with the xref:api-manager::index.adoc[API Manager]
...
* https://blogs.mulesoft.com/dev/mule-dev/role-based-access-controls-on-ion/[Announcement] for more information.
