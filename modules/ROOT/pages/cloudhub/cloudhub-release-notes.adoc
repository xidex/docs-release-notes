...
* "Use Object Store v2" check box selected by default when deploying an application. All new deployments will use Object Store v2 by default unless choosen other wise.
