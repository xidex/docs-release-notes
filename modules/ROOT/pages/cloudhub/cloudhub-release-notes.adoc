...
* "Use Object Store v2" check box is selected by default when deploying an application. All new deployments use Object Store v2 by default unless specifically deselected.
