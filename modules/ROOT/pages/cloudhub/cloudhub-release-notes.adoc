...
* Mule 4 Persistent queue fixes related to vm:listener [SE-11698] and NullPointerException when using Batch module with persistent queues [SE-10583,SE 11599]
