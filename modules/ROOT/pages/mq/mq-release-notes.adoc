...
* Catch exception when a user tries to delete a queue and the queue does not exist. (MQ-726)
* Deleting an environment fails when there are a lot of destinations to delete. (MQ-736)
* Enable Okta users to create a client app. (MQ-1499)
* Queue and message exchange are not showing the name properly when the name is too long. (MQ-1487)
