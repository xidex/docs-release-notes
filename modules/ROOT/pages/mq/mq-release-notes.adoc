...
* FIFO: Ireland (eu-west-1), Northern Virginia (us-east-1), Oregon (us-west-2), Sydney (ap-southeast-2).
...
* FIFO support in Sydney. (https://www.mulesoft.org/jira/browse/MQ-1358)
