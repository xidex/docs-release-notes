...
* Catch Exception when tries to delete a queue and It is not in SQS. (MQ-726)
* Delete environment fails when there are a lot of destinations to delete. (MQ-736)
* Make Okta users able to create a client app. (MQ-1499)
* Queue and message exchange is not showing the name properly when the name is too long. (MQ-1487)
