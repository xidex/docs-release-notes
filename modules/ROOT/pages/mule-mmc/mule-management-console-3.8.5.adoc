...
[NOTE]
Version 3.8.4 of MMC is compatible with Mule runtime v3.8.x starting with version 3.6.x.


== Resolved
* SE-6759 - Remove log4j unused libraries
