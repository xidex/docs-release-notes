...
* Exchange now xref:exchange::to-find-info.adoc[searches] properties defined in RAML and OAS API specifications and the full text of asset portal page content. (EXC-2967)
