...
* When creating a SOAP API, the "File URL" link is now validated. File URLs entered before the validation was in place without a protocol (`http` / `https`) now default to `http`. (EXC-3641)
