...
* Add SVG image support. (EXC-3350)
...
* The "View WSDL" link is now validated. URLs without a protocol default to `http`. (EXC-3641)
* Users can use the mocking service to try the APIs available in public portals with branded domain names. (EXC-3585)
* Keep names synchronized across API versions. (EXC-3568)
...
* Making a version of an API public now depends on validation of that version and not on validation of more recent versions. (EXC-3336)
