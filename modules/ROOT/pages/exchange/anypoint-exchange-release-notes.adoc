...
* Clickable tags and categories in asset detail page. By clicking on a tag or category, Exchange triggers a search of all the asset that contains that tag or category (EXC-3227)
* Image upload on Exchange's markdown editor using drag and drop (EXC-3228) 
