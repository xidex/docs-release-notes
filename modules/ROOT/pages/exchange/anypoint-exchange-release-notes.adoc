...
* Links to websites that do not support iFrames, inside asset portals, maintained by MuleSoft and partners, in the public Exchange (http://www.mulesoft.com/exchange) no longer show a blank page. (EXC-3172)
...
* Correct error message displayed to avoid confusion when the OAS to RAML converter is not able to convert a valid OAS 3 specification. MuleSoft doesn't yet support OAS 3 specifications. (EXC-2552)
...
* Exchange now enables users to publish a WSDL with both the WSDL file and/or the URL for the WSDL file. (EXC-2354)
