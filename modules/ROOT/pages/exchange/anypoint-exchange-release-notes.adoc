...
* Add RAML publication from Anypoint CLI (EXC-2539)
* Exchange integration with Navbar's Recent Items (EXC-3264)

=== Fixed in this Release
* Restrict user for publishing API Specs without any associated file from xAPI (EXC-2541)
* Support JPEG extension for portal resources (EXC-3351)
* Cannot see Terms & Conditions (EXC-3383)
* Type filter is not working on Public portals (EXC-3400)
* User's auth token is included in each requests made with the API Console (EXC-3416)
* Set a max number (50) of pages that can be created in the asset documentation (EXC-3157)
